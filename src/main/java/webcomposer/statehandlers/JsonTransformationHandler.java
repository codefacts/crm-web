 ...
 */
public class JsonTransformationHandler {
    ...
    public JsonTransformationHandler(JsonTransformationPipeline transformationPipeline, JsonTransformationPipelineDeferred transformationPipelineDeferred) {
